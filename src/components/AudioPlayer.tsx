...
export default function AudioPlayer() {
  ...
  return (
    <div 
      className="absolute bottom-22 md:bottom-4 left-4 z-40 bg-stone-900/90 border border-amber-500/20 backdrop-blur-md rounded-full w-12 h-12 flex items-center justify-center shadow-2xl text-stone-200 select-none transition-all duration-300 hover:border-amber-500/50 hover:scale-105"
      onClick={(e) => {
        e.stopPropagation();
