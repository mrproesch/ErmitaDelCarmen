...
function AltarPainting() {
  // Create procedural 2D canvas for Virgen del Carmen retablo matching the beautiful attached engraving style
    ...
    <group position={[0, 4.3, -7.65]}>
      ...
      <mesh position={[0, 0, 0.04]} castShadow>
        ...
        <meshStandardMaterial 
          ...
          emissiveMap={loadedTexture || texture}
